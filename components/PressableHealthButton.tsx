...
interface PressableHealthButtonProps {
    value: string;
    statKey: string;
}

const PressableHealthButton: React.FC<PressableHealthButtonProps> = ({ value, statKey }) => {    
    const [isModalVisible, setIsModalVisible] = useState(false);
    const [ text, setText] = useState("32")
                ...
                <SelectList
                    ...
                    <View style={styles.heroModalContainerButtons}>
                            ...
                            <Pressable
                                ...
                                onLongPress={() => {setText("32"), setIsModalVisible(false), save() }}>
...
export default PressableHealthButton;
